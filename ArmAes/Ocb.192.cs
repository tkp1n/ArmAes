...
public static partial class Ocb
{
        ...
        ref byte tag, nuint tagLen)
    {
        ...
        var adChecksum = ProcessAd192(ctx, ref key.EncryptKeySchedule, ref ad, adLen);
        var offset = GenOffsetFromNonce192(ref nonce, ref key.EncryptKeySchedule, tagLen);
        ...
        if (i > 0)
        {
            ...
            do
            {
                ...
                AesUtil.Encrypt192(ref ta0, ref ta1, ref ta2, ref ta3, ref key.EncryptKeySchedule);
        ...
        fin = AesUtil.Encrypt192(ref key.EncryptKeySchedule, fin);
    ...
    private static bool AeDecrypt192(
        in OcbContext ctx,
        in AesKey key,
        ...
        ref byte tag, nuint tagLen)
    {
        ...
        if (i > 0)
        {
            ...
            do
            {
                ...
                AesUtil.Decrypt192(ref ta0, ref ta1, ref ta2, ref ta3, ref key.DecryptKeySchedule);
        ...
        if (remaining > 0)
        {
            ...
            if (remaining > 0) {
                offset ^= ctx.Lstar;
                var pad = AesUtil.Encrypt192(ref key.EncryptKeySchedule, offset);
        ...
        cTag = AesUtil.Encrypt192(ref key.EncryptKeySchedule, cTag);
        cTag ^= adChecksum;
    ...
    private static Vector128<byte> ProcessAd192(
        in OcbContext ctx,
        ...
        ref byte ad, nuint adLen)
    {
        ...
        if (i > 0)
        {
            ...
            do
            {
                ...
                AesUtil.Encrypt192(ref ta0, ref ta1, ref ta2, ref ta3, ref keySchedule);
