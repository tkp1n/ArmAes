...
{
    private static void AeEncrypt256(
        in OcbContext ctx,
        in AesKey key,
        ...
        ref byte tag, nuint tagLen)
    {
        ...
        var adChecksum = ProcessAd256(ctx, ref key.EncryptKeySchedule, ref ad, adLen);
        var offset = GenOffsetFromNonce256(ref nonce, ref key.EncryptKeySchedule, tagLen);
        ...
        if (i > 0)
        {
            ...
            do
            {
                ...
                AesUtil.Encrypt256(ref ta0, ref ta1, ref ta2, ref ta3, ref key.EncryptKeySchedule);
        ...
        fin = AesUtil.Encrypt256(ref key.EncryptKeySchedule, fin);
    ...
    private static bool AeDecrypt256(
        in OcbContext ctx,
        in AesKey key,
        ...
        ref byte tag, nuint tagLen)
    {
        ...
        if (i > 0)
        {
            ...
            do
            {
                ...
                AesUtil.Decrypt256(ref ta0, ref ta1, ref ta2, ref ta3, ref key.DecryptKeySchedule);
        ...
        if (remaining > 0)
        {
            ...
            if (remaining > 0) {
                offset ^= ctx.Lstar;
                var pad = AesUtil.Encrypt256(ref key.EncryptKeySchedule, offset);
        ...
        cTag = AesUtil.Encrypt256(ref key.EncryptKeySchedule, cTag);
        cTag ^= adChecksum;
    ...
    private static Vector128<byte> ProcessAd256(
        in OcbContext ctx,
        ...
        ref byte ad, nuint adLen)
    {
        ...
        if (i > 0)
        {
            ...
            do
            {
                ...
                AesUtil.Encrypt256(ref ta0, ref ta1, ref ta2, ref ta3, ref keySchedule);
