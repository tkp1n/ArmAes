...
public static partial class Xts
{
    ...
    private static void EncryptDataUnit256(
        in AesKey key,
        ref byte tweak,
        ...
        ref byte ct)
    {
        ...
        while (ptLen >= BytesPerBlock)
        {
            ...
            p0 = AesUtil.Encrypt256(ref keySchedule, p0);
        ...
        if (ptLen > 0)
        {
            ...
            lastCtBlock ^= t0;
            lastCtBlock = AesUtil.Encrypt256(ref keySchedule, lastCtBlock);
            (lastCtBlock ^ t0).StoreUnsafe(ref lastCtBlockRef);
        }
    }

    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    private static void DecryptDataUnit256(
        in AesKey key,
        ref byte tweak,
        ...
        ref byte pt)
    {
        ...
        while (ctLen >= BytesPerBlock * 2)
        {
            ...
            c0 = AesUtil.Decrypt256(ref keySchedule, c0);
